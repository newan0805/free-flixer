    ...
    >
      <div className="relative overflow-hidden rounded-lg bg-gray-900">
        <Image
          ...
          width={500}
          height={750}
          className="movie-poster w-full h-64 sm:h-72 md:h-80 lg:h-96 object-cover transition-all duration-300 group-hover:scale-105"
          priority={false}
          style={{
            aspectRatio: '2 / 3',
            objectFit: 'cover'
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="absolute bottom-4 left-4 right-4">
            ...
            <div className="flex items-center justify-between text-gray-300 text-xs sm:text-sm">
              <span className="bg-black/50 px-2 py-1 rounded">{year}</span>
              {rating && (
